...
### Introduction
This is the final project of the section 'Value-Based Methods' of the Udacity Deep Reinforcement Learning 
nanodegree .
In this project, we need to train an agent to navigate (and collect bananas!) in a large, square world.  
...
4. Download the Unity environment from one of the links below.  You need only select the environment that matches your operating system:
...
Follow the instructions in `Navigation.ipynb` or execute train.py to train the agent.